 ...
 * Current stage: all homepage sections through the Final CTA and footer.
 * (A Results section between Why NorthWing and the Final CTA remains
 * available in the docs if a future issue calls for it.)
 */
